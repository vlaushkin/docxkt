...
internal class Demo43ImagesToTableCell2Test :
    ...
    override fun build(): Document {
        val img1 = loadFixtureBytes("demo-43-images-to-table-cell-2", "word/media/image1.png")
        val img2 = loadFixtureBytes("demo-43-images-to-table-cell-2", "word/media/image2.jpg")
        return document {
            table {
