...
/** JVM `actual` for the multiplatform fixture loader. Reads from the
 *  jvmTest classpath, where Gradle copies `src/jvmTest/resources/fixtures/`. */
internal actual fun loadFixtureBytes(fixtureName: String, partPath: String): ByteArray =
    FixtureLoader.loadBinaryPart(fixtureName, partPath)
